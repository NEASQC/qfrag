...
# ~~~~~~~> Second Part: Intramolecular Fragmentation <~~~~~~~~~
    ...
    def breakingdraw(self, components):
        ...
        nx.draw(G,labels = d, node_color = list(colors_n), edge_color=colors_e, font_weight = 'bold',width=list(w))
    ...
    def fragmentdraw(self, subgraph):
        ...
        colors_n = nx.get_node_attributes(G,'color').values() 
        nx.draw(G,labels = d, node_color = list(colors_n), font_weight = 'bold')
